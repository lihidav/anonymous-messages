...
public abstract class Subscriber extends RunnableSubPub {
    ...
    private ConcurrentHashMap<Class<? extends Message>, Callback> allCallbacks;
    ...
    public Subscriber(String name) {
        ...
        allCallbacks = new ConcurrentHashMap<>();
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        allCallbacks.put(type, callback);
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                Message mess = messageBroker.awaitMessage(this);
                allCallbacks.get(mess.getClass()).call(mess);
